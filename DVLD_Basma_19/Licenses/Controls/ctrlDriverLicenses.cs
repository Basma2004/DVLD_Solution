...
namespace DVLD_Basma_19
{
    public partial class ctrlDriverLicenses : UserControl
    {
        ...
        public void LoadInfoByPersonID(int PersonID)
        {
            ...
            if (_Driver == null)
            {
                MessageBox.Show("This Person is not Driver !!", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void showLicenseInfoToolStripMenuItem2_Click(object sender, EventArgs e)
        {
