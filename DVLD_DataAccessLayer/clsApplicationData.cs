...
namespace DVLD_DataAccessLayer
{
    public class clsApplicationData
    {
                                 ...
                                 DateTime LastStatusDate,float PaidFees,int CreatedByUserID)
        {
            ...
            string query = @"INSERT INTO Applications (ApplicationPersonID,ApplicationDate,ApplicationTypeID,ApplicationStatus,
        ...
        public static bool UpdateApplication(int ApplicationID,int ApplicationPersonID, DateTime ApplicationDate, int ApplicationTypeID, byte ApplicationStatus,
                                 DateTime LastStatusDate, float PaidFees, int CreatedByUserID)
        {
        ...
        public static int GetActiveApplicationID(int PersonID,int ApplicationTypeID)
        {
            ...
            string query = "SELECT ActiveApplicationID=ApplicationID FROM Applications WHERE ApplicationPersonID = @ApplicationPersonID and ApplicationTypeID=@ApplicationTypeID and ApplicationStatus=1";
